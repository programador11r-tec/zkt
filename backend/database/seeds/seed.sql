...
VALUES ('T-001','P123ABC', NULL,'OPEN',
        DATE_SUB(NOW(), INTERVAL 3 HOUR), NULL, NULL, 0.00, NOW())
...
VALUES ('T-002','P987XYZ', NULL,'CLOSED',
        DATE_SUB(NOW(), INTERVAL 5 HOUR), DATE_SUB(NOW(), INTERVAL 2 HOUR), 180, 25.00, NOW())
ON DUPLICATE KEY UPDATE
  plate=VALUES(plate),
  receptor_nit=VALUES(receptor_nit),
  status=VALUES(status),
...
VALUES ('T-003','M555MOTO', NULL,'CLOSED',
        ...
        DATE_SUB(NOW(), INTERVAL 1 DAY), 120, 18.00, NOW())
ON DUPLICATE KEY UPDATE
  plate=VALUES(plate),
  receptor_nit=VALUES(receptor_nit),
  status=VALUES(status),
